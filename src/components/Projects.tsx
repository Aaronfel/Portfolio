...
const Projects: React.FC = () => {
  return (
    <div className="animate__animated animate__bounceInLeft h-full overflow-y-auto flex flex-col lg:flex-row lg:flex-wrap xl:mt-10 justify-evenly rounded-md">
      <Card
        title="Asea Global"
